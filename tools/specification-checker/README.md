...
- [SystemOSIOT 形式化规范检查工具](#systemosiot-形式化规范检查工具)
  - [📋 工具概述](#-工具概述)
  - [🏗️ 系统架构](#️-系统架构)
    - [核心组件](#核心组件)
  - [🔧 功能特性](#-功能特性)
  ...
  - [📊 检查标准](#-检查标准)
    ...
    - [验证规则](#验证规则)
  - [🚀 使用方法](#-使用方法)
    - [证据键一致性检查（Analysis ↔ references.md）](#证据键一致性检查analysis--referencesmd)
    - [基本使用](#基本使用)
    - [高级使用](#高级使用)
  - [📈 性能指标](#-性能指标)
    - [检查性能](#检查性能)
    ...
    - [可扩展性](#可扩展性)
  - [🔍 检查示例](#-检查示例)
    - [示例1: 公理一致性检查](#示例1-公理一致性检查)
    - [示例2: 定理完备性检查](#示例2-定理完备性检查)
    - [示例3: 独立性验证](#示例3-独立性验证)
  - [📋 检查报告](#-检查报告)
    - [报告格式](#报告格式)
  - [🔧 集成接口](#-集成接口)

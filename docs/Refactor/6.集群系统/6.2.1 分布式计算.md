...
- [6.2.1 分布式计算 / Distributed Computing](#621-分布式计算-distributed-computing)
  - [6.2.1.1 分布式计算基础 / Distributed Computing Fundamentals](#6211-分布式计算基础-distributed-computing-fundamentals)
    - [6.2.1.1.1 分布式计算模型 / Distributed Computing Models](#62111-分布式计算模型-distributed-computing-models)
  - [6.2.1.2 MapReduce 编程模型 / MapReduce Programming Model](#6212-mapreduce-编程模型-mapreduce-programming-model)
    - [6.2.1.2.1 MapReduce 框架实现 / MapReduce Framework Implementation](#62121-mapreduce-框架实现-mapreduce-framework-implementation)

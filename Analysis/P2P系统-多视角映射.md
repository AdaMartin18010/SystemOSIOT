...
- [P2P 系统：OS × vSphere/VMware × 容器 × 图灵机 多视角映射](#p2p-系统os--vspherevmware--容器--图灵机-多视角映射)
  - [1. 概述](#1-概述)
    - [1.1 范围与边界（Scope \& Non-goals）](#11-范围与边界scope--non-goals)
  - [2. OS 视角](#2-os-视角)
    - [2.1 形式化定义与语义](#21-形式化定义与语义)
  - [3. vSphere/VMware 视角](#3-vspherevmware-视角)
    - [3.1 对标特性与差异](#31-对标特性与差异)
    - [3.2 运行时影响](#32-运行时影响)
  - [4. 容器视角](#4-容器视角)
    - [4.1 K8s 运行时语义映射](#41-k8s-运行时语义映射)
  - [5. 图灵机视角](#5-图灵机视角)
    - [5.1 可计算性与复杂度](#51-可计算性与复杂度)
    - [5.2 复杂度与工程权衡](#52-复杂度与工程权衡)
  - [6. 多维映射（摘要）](#6-多维映射摘要)
  - [7. 建议](#7-建议)
    - [7.1 基准方法学（Benchmark Methodology）](#71-基准方法学benchmark-methodology)
    - [7.2 统一时间线回放示例（E-2025-0301/0303/0304）](#72-统一时间线回放示例e-2025-030103030304)
  - [8. 相关目录链接](#8-相关目录链接)
  - [9. 参考与链接](#9-参考与链接)

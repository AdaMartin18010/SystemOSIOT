...
- [跨层可观测性：统一时间线与事件关联指南](#跨层可观测性统一时间线与事件关联指南)
  - [1. 目标](#1-目标)
  - [2. 时间与标签](#2-时间与标签)
    - [2.1 OTel 语义与标签命名约定（E-2025-0303）](#21-otel-语义与标签命名约定e-2025-0303)
  - [3. 数据面与控制面](#3-数据面与控制面)
  - [4. 采集与管道](#4-采集与管道)
  - [5. 回放与规则](#5-回放与规则)
    - [5.1 示例查询与面板（Grafana/PromQL/Tempo/Loki）](#51-示例查询与面板grafanapromqltempoloki)
  - [6. 安全与合规](#6-安全与合规)
  - [7. 最佳实践](#7-最佳实践)

...
- **标准与实现 Standards & Implementation**：
  - 中文：[IEEE 802.3](https://standards.ieee.org/standard/802.3-2022.html)标准定义了以太网的帧结构、介质访问控制与物理接口。
  - EN: [IEEE 802.3](https://standards.ieee.org/standard/802.3-2022.html) standard defines Ethernet frame structure, MAC, and physical interfaces.
...
- **标准与实现 Standards & Implementation**：
  - 中文：IPv4（[RFC 791](https://datatracker.ietf.org/doc/html/rfc791)）、IPv6（[RFC 8200](https://datatracker.ietf.org/doc/html/rfc8200)）定义了IP数据报格式、地址结构与分片机制。
  - EN: IPv4 ([RFC 791](https://datatracker.ietf.org/doc/html/rfc791)) and IPv6 ([RFC 8200](https://datatracker.ietf.org/doc/html/rfc8200)) define datagram formats, address structures, and fragmentation.
- **工程实现 Engineering Implementation**：
...
- **标准与实现 Standards & Implementation**：
  - 中文：[RFC 793](https://datatracker.ietf.org/doc/html/rfc793) 定义了 TCP 报文格式、三次握手、流量控制与拥塞控制机制。
  - EN: [RFC 793](https://datatracker.ietf.org/doc/html/rfc793) defines TCP segment format, three-way handshake, flow and congestion control.
- **工程实现 Engineering Implementation**：
...
- **标准与实现 Standards & Implementation**：
  - 中文：HTTP/1.1（[RFC 2616](https://datatracker.ietf.org/doc/html/rfc2616)）、HTTP/2（[RFC 7540](https://datatracker.ietf.org/doc/html/rfc7540)）、HTTP/3（[RFC 9114](https://datatracker.ietf.org/doc/html/rfc9114)）等标准定义了请求格式、连接管理与多路复用。
  - EN: HTTP/1.1 ([RFC 2616](https://datatracker.ietf.org/doc/html/rfc2616)), HTTP/2 ([RFC 7540](https://datatracker.ietf.org/doc/html/rfc7540)), HTTP/3 ([RFC 9114](https://datatracker.ietf.org/doc/html/rfc9114)) define request formats, connection management, and multiplexing.
- **工程实现 Engineering Implementation**：
...
- [IEEE 802.3-2022](https://standards.ieee.org/standard/802.3-2022.html), [RFC 791](https://datatracker.ietf.org/doc/html/rfc791), [RFC 793](https://datatracker.ietf.org/doc/html/rfc793), [RFC 2616](https://datatracker.ietf.org/doc/html/rfc2616), [RFC 7540](https://datatracker.ietf.org/doc/html/rfc7540), [RFC 9114](https://datatracker.ietf.org/doc/html/rfc9114), [ISO/IEC 7498-1](https://www.iso.org/standard/20269.html)
...
- [RFC 1122 — Host Requirements (Communication Layers)](https://datatracker.ietf.org/doc/html/rfc1122)
- [RFC 5681 — TCP Congestion Control](https://datatracker.ietf.org/doc/html/rfc5681)
- [RFC 9110 — HTTP Semantics](https://datatracker.ietf.org/doc/html/rfc9110)
- [RFC 9112 — HTTP/1.1](https://datatracker.ietf.org/doc/html/rfc9112)
- [RFC 9114 — HTTP/3 / QUIC Mapping](https://datatracker.ietf.org/doc/html/rfc9114)

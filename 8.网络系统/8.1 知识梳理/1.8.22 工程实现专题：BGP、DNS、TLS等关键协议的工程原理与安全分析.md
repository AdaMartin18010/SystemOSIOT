...
- **标准与实现 Standards & Implementation**：
  - 中文：[RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271) 定义了 BGP-4 协议结构、消息类型、路径属性等。
  - EN: [RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271) defines BGP-4 protocol structure, message types, and path attributes.
...
- **标准与实现 Standards & Implementation**：
  - 中文：[RFC 1034](https://datatracker.ietf.org/doc/html/rfc1034)/[RFC 1035](https://datatracker.ietf.org/doc/html/rfc1035) 定义了 DNS 协议结构、查询类型、分层架构。
  - EN: [RFC 1034](https://datatracker.ietf.org/doc/html/rfc1034)/1035 define DNS protocol structure, query types, and hierarchical architecture.
- **工程实现 Engineering Implementation**：
...
- **标准与实现 Standards & Implementation**：
  - 中文：[RFC 5246](https://datatracker.ietf.org/doc/html/rfc5246)（TLS 1.2）、[RFC 8446](https://datatracker.ietf.org/doc/html/rfc8446)（TLS 1.3）定义了握手、加密算法、证书认证等。
  - EN: RFC 5246 (TLS 1.2), [RFC 8446](https://datatracker.ietf.org/doc/html/rfc8446) (TLS 1.3) define handshake, encryption algorithms, and certificate authentication.
- **工程实现 Engineering Implementation**：
...
- [RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271), [RFC 1034](https://datatracker.ietf.org/doc/html/rfc1034), [RFC 1035](https://datatracker.ietf.org/doc/html/rfc1035), [RFC 5246](https://datatracker.ietf.org/doc/html/rfc5246), [RFC 8446](https://datatracker.ietf.org/doc/html/rfc8446), DNSSEC, RPKI, [ISO/IEC 7498-1](https://www.iso.org/standard/20269.html)

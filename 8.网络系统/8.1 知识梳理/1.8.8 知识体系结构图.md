...
- 中文：
  ...
  - **国际标准映射**：IETF（RFC系列）、IEEE（802系列）、[3GPP](https://www.3gpp.org/specifications)（5G标准）、ISO/IEC（OSI模型）、ITU-T（电信标准）等国际标准组织推动知识体系的标准化。
...
- EN:
  ...
  - **International Standards Mapping**: International standards organizations such as IETF (RFC series), IEEE (802 series), [3GPP](https://www.3gpp.org/specifications) (5G standards), ISO/IEC (OSI model), ITU-T (telecommunications standards) promote standardization of the knowledge system.

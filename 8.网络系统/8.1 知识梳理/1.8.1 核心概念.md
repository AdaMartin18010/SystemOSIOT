...
- 中文：
  ...
  - **国际标准**：IETF（TCP/IP、HTTP）、IEEE（802系列）、[3GPP](https://www.3gpp.org/specifications)（5G）、ISO/IEC（OSI）、ITU-T等国际标准组织推动核心概念的标准化。
- EN:
  ...
  - **International Standards**: International standards organizations such as IETF (TCP/IP, HTTP), IEEE (802 series), [3GPP](https://www.3gpp.org/specifications) (5G), ISO/IEC (OSI), ITU-T promote standardization of core concepts.

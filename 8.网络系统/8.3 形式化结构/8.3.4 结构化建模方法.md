...
- 中文：
  - **OSI参考模型建模**：基于[ISO/IEC 7498-1](https://www.iso.org/standard/20269.html)标准的七层网络架构建模方法。
  - **TCP/IP协议栈建模**：基于[RFC 1122](https://datatracker.ietf.org/doc/html/rfc1122)标准的四层协议栈建模方法。
  - **SDN架构建模**：基于ONF标准的软件定义网络架构建模方法。

- EN:
  - **OSI Reference Model Modeling**: Seven-layer network architecture modeling method based on [ISO/IEC 7498-1](https://www.iso.org/standard/20269.html) standard.
  - **TCP/IP Protocol Stack Modeling**: Four-layer protocol stack modeling method based on [RFC 1122](https://datatracker.ietf.org/doc/html/rfc1122) standard.
...
- 中文：
  ...
  - **TCP协议建模**：基于[RFC 793](https://datatracker.ietf.org/doc/html/rfc793)标准的TCP连接状态建模。
  - **BGP协议建模**：基于[RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271)标准的BGP路由协议建模。

- EN:
  - **HTTP Protocol Modeling**: HTTP protocol state machine modeling based on RFC 7230-7237 standards.
  - **TCP Protocol Modeling**: TCP connection state modeling based on [RFC 793](https://datatracker.ietf.org/doc/html/rfc793) standard.
  - **BGP Protocol Modeling**: BGP routing protocol modeling based on [RFC 4271](https://datatracker.ietf.org/doc/html/rfc4271) standard.

### 2.3 安全协议建模

- 中文：
  - **TLS协议建模**：基于RFC 5246标准的TLS握手协议建模。
  - **IPSec协议建模**：基于[RFC 4301](https://datatracker.ietf.org/doc/html/rfc4301)标准的IPSec安全协议建模。
  - **Kerberos协议建模**：基于RFC 4120标准的Kerberos认证协议建模。

- EN:
  - **TLS Protocol Modeling**: TLS handshake protocol modeling based on RFC 5246 standard.
  - **IPSec Protocol Modeling**: IPSec security protocol modeling based on [RFC 4301](https://datatracker.ietf.org/doc/html/rfc4301) standard.

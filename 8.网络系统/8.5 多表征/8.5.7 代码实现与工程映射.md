...
- 中文：
  ...
  - 典型案例：Linux内核网络协议实现、Mininet网络仿真、[OpenFlow](https://opennetworking.org/software-defined-standards/)控制器开发等。
- EN:
  - TCP/IP stack development, SDN controller implementation, BGP router simulation, automated network security detection, etc.
  - Typical cases: Linux kernel network protocol implementation, Mininet network simulation, [OpenFlow](https://opennetworking.org/software-defined-standards/) controller development, etc.
